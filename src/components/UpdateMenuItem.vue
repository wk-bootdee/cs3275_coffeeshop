<template>
    <div class="container">
        ...
        <table class="table">
            ...
            <tbody>
                <tr v-for="menuItem in menuItems" :key="menuItem.menuItemId">
                    ...
                    <td>{{menuItem.menuItemImage}}</td>
                    <td>
                        <router-link :to="{name: 'updateMenuItem', params: {id: menuItem.menuItemId}}" class="btn btn-primary">Update</router-link>
                    </td>
                </tr>
            </tbody>
        </table>
